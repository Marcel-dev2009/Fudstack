...
export const navItems = [
  ...
  export   const resNavItems = [
      ...
      },
      {
        ...
        name: "Products",
        icon: Package,
          route: "/restaurants/products",
        dropdown: false,
      },
      {
         id:"3",
        name: "Sales",
          route: "/restaurants/sales",
        icon: BarChart3,
      },
      {
         id:"4",
        name: "Notifications",
        icon: Bell,
          route: "/restaurants/notifications",
        dropdown: false,
