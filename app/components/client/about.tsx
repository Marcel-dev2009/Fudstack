  ...
  return (
    ...
    <section className="bg-black text-white min-h-screen h-auto">
      ...
      <div className="flex flex-col lg:flex-row  justify-evenly ">
           <div className="bg-secondary-onyx/20 backdrop-blur-sm rounded-2xl w-auto max-w-75">
       ...
       <div>
          <h2 className="w-auto max-w-md font-semibold text-xl text-center md:text-2xl align-baseline tracking-tighter">We automate your tasks without the friction of complexity.</h2>
          ...
          <div className="mt-2 p-4  gap-8">
             ...
             <div className="w-full flex justify-center">
              <Button className="m-2 w-1/3 tracking-tight">   Read More <MoveRight data-icon="inline-end"/> </Button>      
              </div> 
          </div>
          <div
          className="grid"
